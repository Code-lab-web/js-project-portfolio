...
URL=$(wget -qO - https://api.github.com/repos/cupcakearmy/autorestic/releases/latest | grep "browser_download_url.*_${OS}_${ARCH}" | cut -d : -f 2,3 | tr -d \" | sed 's/ //g')
wget -qO "${OUT_FILE}.bz2" "$URL"
